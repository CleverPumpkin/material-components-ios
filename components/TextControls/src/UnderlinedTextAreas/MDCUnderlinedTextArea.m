...
#import "MDCUnderlinedTextArea.h"
...
@interface MDCUnderlinedTextArea (Private) <MDCTextControl>
@end

@implementation MDCUnderlinedTextArea

- (instancetype)initWithFrame:(CGRect)frame {
  self = [super initWithFrame:frame];
  if (self) {
    [self commonMDCUnderlinedTextAreaInit];
  }
  return self;
}
...
- (void)commonMDCUnderlinedTextAreaInit {
